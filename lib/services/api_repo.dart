...
class ApiRepo {
  ...
  ///Baseball
  Future<List<OtherModel>> getBaseballTodayList() async {
    try {
      final response = await apiUtils.get(
  ...
  Future<List<SportDate>> getBaseballDateList() async {
    try {
      final response = await apiUtils.get(
  ...
  Future<List<OtherModel>> getBaseballHistoryList(String date) async {
    try {
      final response = await apiUtils.get(
          url:
