import 'package:betting_tips/views/screens/tips/volleyball/volleyball_history_screen.dart';
import 'package:betting_tips/views/screens/tips/volleyball/volleyball_today_screen.dart';
          ...
          child: TabBarView(
            ...
            children: [
              Padding(
                ...
                child: const VolleyballTodayScreen(),
              ),
              Padding(
                padding: EdgeInsets.only(top: 10.h),
                child: const VolleyballHistoryScreen(),
              ),
            ],
          ),
        ),
