import 'package:betting_tips/views/screens/tips/hockey/hockey_history_screen.dart';
import 'package:betting_tips/views/screens/tips/hockey/hockey_today_screen.dart';
          ...
          child: TabBarView(
            ...
            children: [
              Padding(
                ...
                child: const HockeyTodayScreen(),
              ),
              Padding(
                padding: EdgeInsets.only(top: 10.h),
                child: const HockeyHistoryScreen(),
              ),
            ],
          ),
        ),
