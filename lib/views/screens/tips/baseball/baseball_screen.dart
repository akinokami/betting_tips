import 'package:betting_tips/views/screens/tips/baseball/baseball_history_screen.dart';
import 'package:betting_tips/views/screens/tips/baseball/baseball_today_screen.dart';
          ...
          child: TabBarView(
            ...
            children: [
              Padding(
                ...
                child: const BaseballTodayScreen(),
              ),
              Padding(
                padding: EdgeInsets.only(top: 10.h),
                child: const BaseballHistoryScreen(),
              ),
            ],
          ),
        ),
