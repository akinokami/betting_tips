import 'package:betting_tips/views/screens/tips/basketball/basket_history_screen.dart';
import 'package:betting_tips/views/screens/tips/basketball/basket_today_screen.dart';
          ...
          child: TabBarView(
            ...
            children: [
              Padding(
                ...
                child: const BasketTodayScreen(),
              ),
              Padding(
                padding: EdgeInsets.only(top: 10.h),
                child: const BasketHistoryScreen(),
              ),
            ],
          ),
        ),
